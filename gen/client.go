				...
				History struct {
					Nodes []*struct {
						File *struct {
							...
							} "json:\"object\" graphql:\"object\""
						} "json:\"file\" graphql:\"file\""
					} "json:\"nodes\" graphql:\"nodes\""
				} "json:\"history\" graphql:\"history\""
			} "json:\"target\" graphql:\"target\""
		} "json:\"defaultBranchRef\" graphql:\"defaultBranchRef\""
...
const GetFileDocument = `query GetFile ($fileName: String!) {
...
func (c *Client) GetFile(ctx context.Context, fileName string, interceptors ...clientv2.RequestInterceptor) (*GetFile, error) {
